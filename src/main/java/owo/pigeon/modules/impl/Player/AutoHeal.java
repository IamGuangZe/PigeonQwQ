...
public class AutoHeal extends Module {
    ...
    public ModeSetting<switchModeEnum> switchMode = setting("switch-mode", switchModeEnum.NORMAL, v -> true);
    public IntSetting switchTick = setting("switch-tick", 2, 1, 20, v -> switchMode.getValue() == switchModeEnum.NORMAL);
